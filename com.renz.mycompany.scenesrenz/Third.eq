public class Third : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("ave3", "ave3", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=#000000", 80);
			
			main = add_sprite_for_image(SEImage.for_resource("button"));
		    sprite = add_sprite_for_image(SEImage.for_resource("ave3"));
			text = add_sprite_for_text("3RD SCENE", "myfont");
